document.addEventListener('DOMContentLoaded', () => {
    ...
    var STARTPOSITION = Math.floor(BOARDWIDTH / 2) - 1;
    var NEXTFIGURESNUM = 1;
    ...
    var FIGURES = [
        ...
        {
            cells: [1, BOARDWIDTH, BOARDWIDTH + 2, BOARDWIDTH * 2 + 1],
            width: 3,
            color: 'xFigure',
        },
        {
            cells: [0, BOARDWIDTH, BOARDWIDTH * 2 + 1, BOARDWIDTH * 3 + 1],
            width: 4,
            color: 'qFigure',
        },
        {
            cells: [1, BOARDWIDTH + 1, BOARDWIDTH * 2, BOARDWIDTH * 3],
            width: 4,
            color: 'pFigure',
        },
        {
    ...
    function gameOver() {
        ...
        scoreTable.push(gameBoard.score);
        ...
        for (var i = 0; i < scoreTable.length; i++) {
            ...
            cell.innerHTML = i + 1 + " место:   " + scoreTable[i];
    ...
    nextFigure.style.width = (maxFigureSize * 40) + 'px';
    nextFigure.style.height = (maxFigureSize * 40 * NEXTFIGURESNUM) + 'px';
    ...
    function setNewFigure() {
        ...
        for (var j = 0; j < gameBoard.nextFigures.length; j++) {
            var nfColor = FIGURES[gameBoard.nextFigures[j]].color;
            var nfCells = FIGURES[gameBoard.nextFigures[j]].cells.map(cell => {
            ...
            for (var i = 0; i < maxFigureSize * maxFigureSize; i++) {
                ...
                nfCells.includes(i) && cell.classList.add(nfColor);

                nextFigure.appendChild(cell);
            }
        }
        ...
        gameBoard.currentPosition = STARTPOSITION;
        gameBoard.nextPosition = gameBoard.currentPosition;
    }
